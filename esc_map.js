...
//cursor
	...
	'CSI Ps @': function(p) {this.line_insert(p?p*1:1); },//Insert P s (Blank) Character(s) (default = 1) (ICH)
	...
	'CSI Ps X' : function(p) { this.line_erase(p?p*1:1); },  //Erase Ps Character(s) (default = 1) (ECH).
